import { AfterContentInit, OnDestroy, Renderer2, ElementRef, EventEmitter, OnChanges, SimpleChanges, InjectionToken } from '@angular/core';
...
export declare class MdlScreenSizeService {
    ...
    constructor(layoutScreenSizeThreshold: number);
